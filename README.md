...
Кнопка "Сканировать" по центру экрана открывает камеру, которая распознаёт QR код.
После чтения открывается AR интерфейс c соответствующим 3д объектом.
...
Каждый сценарий создаёт код, который затем может быть загружен в плату микроконтроллера по WIFI для выполнения сценария.
